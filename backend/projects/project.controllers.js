...
export const createProject = async (req, res, next) => {
    ...
    try {
        ...
        const newProject = await dbGet("SELECT * FROM projects WHERE project_id = ?", [result.lastID]);
...
export const editProject = async (req, res, next) => {
    ...
    try {
        ...
        const updatedProject = await dbGet("SELECT * FROM projects WHERE project_id = ?", [projectId]);
